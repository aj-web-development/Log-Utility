...
import com.in10s.logutility.project.ProjectRepository;
...
class ProjectServiceTest {
    ...
    void loadForEditRoundTrips() {
        ...
        assertThat(form.getNodes().get(0).getLastCheckStatus()).isEqualTo(com.in10s.logutility.project.CheckStatus.UNKNOWN);
    }
    ...
    void recordLogSourceCheckUpdatesNodeForDisplay() {
        ...
        assertThat(reloaded.getLastCheckStatus()).isEqualTo(com.in10s.logutility.project.CheckStatus.REACHABLE);
